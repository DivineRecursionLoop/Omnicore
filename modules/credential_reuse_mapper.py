...
matches.append(self.intel_database[4])
elif "ssh" in banner_lower:
matches.append(self.intel_database[2])
elif "mysql" in banner_lower:
matches.append(self.intel_database[3])
elif "http" in banner_lower or "apache" in banner_lower or "nginx" in banner_lower:
matches.append(self.intel_database[5])
...
self.workspace.add_finding(self.name, ip, match["risk_level"], json.dumps(finding_entry))
else :
